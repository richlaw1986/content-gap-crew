/**
 * One-time patch: update the crew planner's system prompt.
 * Ensures Work Reviewer is always included in every plan.
 *
 * Usage:
...
async function main() {
  ...
  await client
    ...
    .set({ systemPrompt })
    .commit()
  console.log('✓ Planner prompt updated — Work Reviewer now mandatory in every plan')
}
